...
<head>
    ...
    <title>Resend Confirm Email</title>
...
<div class="container">
    <form class="form-horizontal" role="form" method="POST" action="{{ route('verify.resendVerifyEmail') }}">
        {{ csrf_field() }}
        <h2>Gửi Lại Email Xác Nhận</h2>
        @if(session()->has('message'))
            <div style="text-align: center">
                <h3 style="font-weight: bold">{{ session()->get('message') }}</h3>
            </div>
        @endif
